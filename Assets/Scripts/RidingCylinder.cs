...
{
    private bool _filled;       // silindirin tam dolup dolmadığını tutacak
    private float _value;       // silindirin ne kadar dolduğunu tutacak
    ...
    public void IncrementCylinderVolume(float value)
    {
        ...
        {
            PlayerController.Current.DestroyCylinder(this); // game over
        }
        else
        {
            int cylinderCount = PlayerController.Current.cylinders.Count;
